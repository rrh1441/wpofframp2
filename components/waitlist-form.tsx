    ...
    return (
        ...
        <Card className="w-full">
            <CardHeader>
                ...
                <CardDescription>Be the first to know as we expand WP Offramp! Full-site migration, theme customization, and managed options are coming soon.</CardDescription>
            </CardHeader>
            <CardContent>
